# -*- coding: utf-8 -*-
"""
Created on Tue Oct 30 11:57:57 2018
...
inHeight = 368
thr = 0.1
protoc = "../model/pose_deploy_linevec.prototxt"
#protoc ='D:/pydemo/pose0/pose_deploy_linevec.prototxt'
...
#model = 'D:/pydemo/pose0/pose_iter_160000.caffemodel'
net = cv.dnn.readNetFromCaffe(protoc, model)

cap = cv.VideoCapture('cxk.mp4')
height = cap.get(cv.CAP_PROP_FRAME_HEIGHT)
width = cap.get(cv.CAP_PROP_FRAME_WIDTH)
#video_writer = cv.VideoWriter("pose_estimation_demo.mp4", cv.VideoWriter_fourcc('D', 'I', 'V', 'X'), 25, (640, 480), True)
video_writer = cv.VideoWriter("pose_estimation_demo.avi", cv.VideoWriter_fourcc('M', 'J', 'P', 'G'), 25, (640, 480), True)
